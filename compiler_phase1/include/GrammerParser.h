...
private:
    ...
    int statenum = 0;
    unordered_map<string,Graph*> definitions;//letter   digit
    unordered_map<string,Graph*> expressions;//token and graph of(digits num ...if else...boolean int...{}();)
    vector<string> expNames;//tokens of expressions
